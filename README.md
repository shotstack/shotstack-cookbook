...
- [news-article-videos](examples/news-article-videos) renders one vertical video per article from one fixed template: a headline and two images filled in with merge fields. The finished video URL is written back onto the article, so a rerun only renders new stories.
